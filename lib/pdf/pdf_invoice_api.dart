...
import 'package:untitled3/pdf/utils.dart';
...
class PdfInvoiceApi {
  ...
  static Widget buildHeader(Invoice invoice) => Column(
    ...
    children: [
      ...
      Row(
        ...
        children: [
          buildSupplierAddress(invoice.supplierPDF),
          Container(
            height: 50,
            width: 50,
            child: BarcodeWidget(
      ...
      Row(
        ...
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          buildCustomerAddress(invoice.customerPDF),
  ...
  static Widget buildFooter(Invoice invoice) => Column(
    ...
    children: [
      Divider(),
      SizedBox(height: 2 * PdfPageFormat.mm),
      buildSimpleText(title: 'Address', value: invoice.supplierPDF.address),
      SizedBox(height: 1 * PdfPageFormat.mm),
      buildSimpleText(title: 'Payment Type: ', value: invoice.supplierPDF.paymentInfo),
    ],
  );
