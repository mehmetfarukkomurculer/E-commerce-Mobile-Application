...
class SalesManagerRegister extends StatefulWidget {
  const SalesManagerRegister({Key? key}) : super(key: key);

  @override
  State<SalesManagerRegister> createState() => _SalesManagerRegisterState();
}

class _SalesManagerRegisterState extends State<SalesManagerRegister> {
  ...
  CollectionReference salesManagers = FirebaseFirestore.instance.collection('salesManagers');
  ...
  void register() async {
    ...
    if(_formKey.currentState!.validate()){
      try{
        ...
        await salesManagers.doc(_uid).set({
          'name' : name,
          'email': email,
          'number': number,
          'password': password,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          const Text('SM Register', style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold),),
                          IconButton(
                              onPressed: (){
