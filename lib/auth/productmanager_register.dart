...
class ProductManagerRegister extends StatefulWidget {
  const ProductManagerRegister({Key? key}) : super(key: key);

  @override
  State<ProductManagerRegister> createState() => _ProductManagerRegisterState();
}

class _ProductManagerRegisterState extends State<ProductManagerRegister> {
  ...
  CollectionReference productManagers = FirebaseFirestore.instance.collection('productManagers');
  ...
  void register() async {
    ...
    if(_formKey.currentState!.validate()){
      try{
        ...
        await productManagers.doc(_uid).set({
          'name' : name,
          'email': email,
          'number': number,
          'password': password,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          const Text('PM Register', style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold),),
                          IconButton(
                              onPressed: (){
